        ...
        <CardContent className="pt-6">
          <ProductForm
            ...
            initialData={{
              ...
              isTaxInclusive: product.is_tax_inclusive !== undefined ? product.is_tax_inclusive : product.isTaxInclusive,
              isCouponExcluded: product.is_coupon_excluded !== undefined ? product.is_coupon_excluded : product.isCouponExcluded,
              tags: product.tags || [],
              ...
              sku: product.sku,
              category: String(product.category_id || product.category || product.categoryId),
              mrp: product.mrp,
              ...
              additionalFeatures: (product.additional_features || product.additionalFeatures)?.map((f: any) => ({
                title: f.title,
                value: f.value,
                isHighlighted: f.is_highlighted !== undefined ? f.is_highlighted : f.isHighlighted,
              })) || [],
              isRecommended: product.is_recommended !== undefined ? product.is_recommended : product.isRecommended,
              ...
              subCategoryId: (product.sub_category_id || product.subCategory || product.subCategoryId) ? String(product.sub_category_id || product.subCategory || product.subCategoryId) : undefined,
            }}
          />
          </CardContent>
        </Card>
