...
export function AppointmentInvoice({ invoice }: { invoice: InvoiceData }) {
    // React.useEffect(() => {
    ...
    return (
        <Card className="max-w-[210mm] mx-auto my-8 p-0 border shadow-lg print:shadow-none print:border-none print:m-0 bg-white text-[11px] font-sans text-black leading-tight border-none">
            ...
            <div className="border border-gray-400 m-4 print:m-0">
                ...
                <div className="grid grid-cols-2 bg-gray-100 border-b border-gray-400 font-bold uppercase text-[10px] tracking-wider text-gray-700">
                    <div className="p-1 px-2 border-r border-gray-400">Bill To (Customer Name)</div>
                    <div className="p-1 px-2">Service Address</div>
                </div>
                ...
                <div className="p-3 border-b border-gray-400 bg-white">
                    ...
                    <p className="text-gray-900 font-medium italic underline underline-offset-2">Tax Invoice for your recent appointment {invoice.invoiceNumber}. Includes {invoice.items.length} items.</p>
                </div>
