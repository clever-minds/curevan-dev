  ...
  return (
    <div className={cn("flex items-center gap-2 shrink-0", className)}>
       <svg
        ...
        className="w-8 h-10 sm:w-10 sm:h-12 logo-svg"
        viewBox="0 0 107.83 139.37"
      >
        <defs>
          <linearGradient id={gradientId} x1="22.36" y1="24.55" x2="107.23" y2="109.43" gradientUnits="userSpaceOnUse">
