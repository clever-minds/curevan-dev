...
const controllerPath = 'C:\\curevan_node\\src\\controllers\\therapist\\therapistAvailabilityController.js';
...
const importStr = 'const therapistAvailabilityController = require("../controllers/therapist/therapistAvailabilityController");\n';
if (!routesCode.includes('therapistAvailabilityController')) {
  routesCode = importStr + routesCode;
